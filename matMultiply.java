	...
	public void testMultiplyAndAdd() {
		...
		mat m = new mat();
		 ...
		 //reading file for populating inputs
		   list2d =  m.readfile();
		 if(list2d.size()<3){
			System.out.println("Error occured there are not enough matrices to apply operations upon"); 
		 }else{
          ...
          list2d.size();
          //intlist2d.get(0);
          temp = m.multiply(list2d.get(0),list2d.get(1),r,rt1,c,ct1);
          if(temp != null){
        	  
        	  result = m.add(temp,mat2,r,rt2,ct1,ct2);
        ...
        //printing result
		 if(result != null){
          System.out.println("Result of multiplication of two matrices then addtion of third to result");
          for ( l = 0 ; l < r ; l++ )
	         {
	            for ( d = 0 ; d < c ; d++ )
